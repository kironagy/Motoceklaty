...
class ConversationLoopGuard
{
    ...
    private function fallbackRewrite(string $reply, bool $escapeHatch): string
    {
        ...
        if (! $escapeHatch) {
            /*
             * "يمكن سؤالي مكانش واضح" مالهاش معنى قدام رد معلوماتي مش
             * سؤال، فبنحطها بس لما الرسالة فعلًا بتنتهي بسؤال.
             */
            $prefix = str_ends_with(rtrim($core), '؟') || str_ends_with(rtrim($core), '?')
                ? "معلش يا فندم، يمكن سؤالي مكانش واضح.\n"
                : "أوضحهالك تاني يا فندم:\n";
